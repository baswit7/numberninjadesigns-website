# Architectuur - LeersystemenVerkoop

## Doel
Een uitbreidbare projectarchitectuur ontwerpen voor: Een verkoopgerichte workflow voor leersystemen, van leadinformatie tot opvolging en inzicht in conversie.
...
## Functionele Grenzen
- Primair domein: Sales operations, kennisproducten, CRM-koppeling en rapportage.
- Integratiestatus: CRM-, e-mail- en planningskoppelingen zijn nog niet geselecteerd.
...
## Randvoorwaarde
Sla klantdata uitsluitend op na privacy- en toegangsontwerp.
