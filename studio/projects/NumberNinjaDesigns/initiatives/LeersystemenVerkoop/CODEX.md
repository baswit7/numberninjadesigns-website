# Codex Instructies - LeersystemenVerkoop

## Doel
Codex voert wijzigingen voor **LeersystemenVerkoop** uit binnen deze projectgrens en houdt de technische documentatie synchroon met de implementatie.

## Projectfocus
- Domein: Sales operations, kennisproducten, CRM-koppeling en rapportage.
- Huidige prioriteit: Salesfunnel, databronnen, privacygrenzen en KPI-definities uitwerken.
- Kritieke randvoorwaarde: Sla klantdata uitsluitend op na privacy- en toegangsontwerp.
