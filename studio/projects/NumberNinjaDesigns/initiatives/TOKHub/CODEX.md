# Codex Instructies - TOKHub

## Doel
Codex voert wijzigingen voor **TOKHub** uit binnen deze projectgrens en houdt de technische documentatie synchroon met de implementatie.

## Projectfocus
- Domein: Social media automation, trendanalyse, SEO en engagement.
- Huidige prioriteit: Databronnen, auth-strategie, retrybeleid en content review-flow vastleggen.
- Kritieke randvoorwaarde: Geen automatische publicatie of credential-opslag zonder expliciete security review.
