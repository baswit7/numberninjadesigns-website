...
Etsy statement under the old NumberNinjaTees identity. It did not name the exact
...
Before submission, the owner must verify that the canonical host is live,
controlled by the app owner and clearly presents NumberNinjaDesigns as the sole
identity.
...
- Developer contact: api@ninjanumbertees.com
- Privacy contact: privacy@ninjanumbertees.com
