...
Local-first intelligence layer for Finance Product Factory. It imports marketplace CSV files, normalizes heterogeneous signals and turns them into ranked product decisions, blueprints, variant plans and revenue forecasts.
