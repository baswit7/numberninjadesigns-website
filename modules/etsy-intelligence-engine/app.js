...
const production = requestedProduction === 'physical' ? 'physical' : 'digital';
const productionLabel = production === 'physical' ? 'PHYSICAL PRODUCTION' : 'DIGITAL PRODUCTION';
...
let state = loadState(production), analysis = state.rows.length ? analyzeMarket(state.rows, ENGINE_CONFIG) : null, active = 'overview', query = '', selected = null, niche = 'ALL NICHES';
